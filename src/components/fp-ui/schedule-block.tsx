...
export function FPScheduleBlock({
  ...
  if (gap) {
    return (
      <div
        className={cn(
          "fp-label flex items-center px-2 text-[var(--text-micro)] text-fp-warn border border-dashed border-fp-warn bg-fp-bg-page",
          className
        )}
  ...
  return (
    <div
      className={cn("font-fp-mono px-2 py-1 text-[var(--text-micro)] tracking-[0.02em] overflow-hidden", className)}
