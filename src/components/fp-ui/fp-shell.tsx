  ...
  return (
    <div className="flex min-h-screen flex-col bg-fp-bg-page text-fp-text-body">
      <header className="sticky top-0 z-40 flex items-center gap-5 border-b border-fp-border-default bg-fp-bg-surface px-6 py-3">
        <Link href="/new" className="select-none font-fp-display text-[var(--text-h)] font-bold tracking-[-0.01em] text-fp-text-strong">
          FFCS Planner
        </Link>
        <nav className="fp-label hidden items-center gap-[6px] text-[var(--text-micro)] lg:flex">
          {navItems.map((item) => {
          ...
          {campus ? (
            <div className="relative">
              <button
                ...
                className="fp-label inline-flex items-center gap-1.5 rounded-[var(--radius-md)] border border-fp-border-default px-2.5 py-1.5 text-[var(--text-micro)] text-fp-text-dim hover:text-fp-text-body"
              >
                    ...
                    {campusOptions.map((option) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "flex w-full items-center justify-between rounded-[var(--radius-sm)] px-3 py-2 text-left text-[var(--text-small)]",
                            option.active
      ...
      <footer className="flex items-center gap-4 border-t border-fp-border-default bg-fp-bg-surface px-6 py-5">
        ...
        <div className="ml-auto flex gap-5 text-[var(--text-small)] text-fp-text-dim">
  ...
  return (
    <div className="flex min-h-[calc(100vh-14rem)] items-center justify-center py-8">
      <div className="w-full max-w-2xl text-center">
        ...
        <p className="mx-auto mt-3 max-w-xl text-[var(--text-body-size)] leading-[1.5] text-fp-text-dim">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4">
          {campusOptions.map((option) => (
            ...
            >
              <div className="font-fp-display text-[var(--text-h)] font-bold text-fp-text-strong">
                {CAMPUS_LABELS[option.campus]}
              </div>
        ...
        <p className="mt-6 text-[var(--text-small)] text-fp-text-dim">You can change this anytime in Settings.</p>
      </div>
    </div>
  );
}
