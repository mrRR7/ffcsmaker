  ...
  return (
    <div className="space-y-4 p-6">
      ...
      <textarea
        ...
        rows={8}
        className="w-full rounded-[var(--radius-md)] border border-fp-border-strong bg-fp-bg-inset px-[14px] py-[11px] font-fp-mono text-[var(--text-small)] text-fp-text-body placeholder:text-fp-text-dim focus:border-fp-border-accent focus:outline-none"
      />
