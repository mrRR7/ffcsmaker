        ...
        <div className="border-b border-fp-border-default px-6 py-6">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-1.5 text-[var(--text-small)] text-fp-text-dim">
            ...
            {PLANNER_TABS.map((item) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "fp-label inline-flex items-center gap-2 rounded-[var(--radius-sm)] border px-3 py-[7px] text-[var(--text-micro)] transition-colors",
