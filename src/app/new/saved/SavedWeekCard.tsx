  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        {editing ? (
          ...
          <button
            ...
            className="mt-1 block truncate text-left font-fp-display text-[length:var(--text-h)] font-bold text-fp-text-strong transition-colors hover:text-fp-accent"
          >
            {saved.name}
          </button>
        )}
      ...
      <div className="flex flex-col items-end gap-2.5">
        <span
          className="font-fp-mono text-[length:var(--text-title)]"
