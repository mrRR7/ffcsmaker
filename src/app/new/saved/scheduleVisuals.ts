 ...
 * lunch columns dropped. Used to draw the compact "week shape" thumbnail on
 * each Saved list row without re-deriving matrix logic. (Co-located copy of
 * the identical helper in src/app/new/compare/ so each route stays
 * self-contained.)
 */
