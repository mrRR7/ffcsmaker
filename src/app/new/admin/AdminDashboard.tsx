  ...
  return (
    <div className="space-y-5 pb-16">
      <FPPanel>
        <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 font-fp-display text-[length:var(--text-title)] font-bold text-fp-text-strong">Course upload</h1>
      ...
      <FPPanel title="Semester">
        <div className="grid gap-4 p-4 md:grid-cols-2">
          ...
          <label className="flex items-center gap-3 rounded-[var(--radius-md)] border border-fp-border-default bg-fp-bg-inset px-3 py-[9px]">
            ...
            <span className="text-[length:var(--text-small)] text-fp-text-body">Set as active semester</span>
          </label>
          <div className="space-y-2">
      ...
      <FPPanel title="Preview">
        <div className="space-y-4 p-4">
          <p className="text-[length:var(--text-small)] text-fp-text-dim">
            {rows.length} rows, {summary.courseCount} unique courses, {summary.errorCount} errors
          </p>

          {rows.length === 0 ? (
            <div className="rounded-[var(--radius-md)] border border-dashed border-fp-border-default bg-fp-bg-inset p-8 text-center text-[length:var(--text-small)] text-fp-text-dim">
          ...
          {status ? <p className="text-[length:var(--text-small)] text-fp-accent">{status}</p> : null}
